  ...
  constructor(
    ...
    getStateCentroid(stateCode: string): {lat: number; lng: number} {
      switch(stateCode) {
        ...
        case 'MT': return {lat: 41.183753, lng: -97.403875};
        case 'NC': return {lat: 47.375168, lng: -99.334736};
        case 'ND': return {lat: 40.480854, lng: -82.749366};
        case 'NE': return {lat: 37.165965, lng: -116.304648};
        case 'NH': return {lat: 40.438458, lng: -74.428055};
        case 'NJ': return {lat: 34.623012, lng: -106.342108};
        case 'NM': return {lat: 41.507548, lng: -74.645228};
        case 'NV': return {lat: 43.153046, lng: -71.463342};
